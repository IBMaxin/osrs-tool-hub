...
class TestSlayerTasksEndpoint:
    ...
    def test_get_tasks_for_master(self, client: TestClient, session: Session,
    ...
    def test_get_tasks_for_konar(self, client: TestClient, session: Session,
                                 sample_monsters: list[Monster],
                                 sample_slayer_tasks: list[SlayerTask]):
    ...
    def test_get_tasks_verify_monster_data(self, client: TestClient, session: Session,
                                          sample_monsters: list[Monster],
                                          sample_slayer_tasks: list[SlayerTask]):
...
class TestSlayerAdviceEndpoint:
    ...
    def test_get_task_advice(self, client: TestClient, session: Session,
                            sample_monsters: list[Monster],
                            sample_slayer_tasks: list[SlayerTask]):
    ...
    def test_get_advice_for_nonexistent_task(self, client: TestClient, session: Session):
        ...
        data = response.json()
        assert "error" in data.get("detail", "").lower() or "not found" in data.get("detail", "").lower()
    
    def test_get_advice_returns_valid_recommendation(self, client: TestClient, session: Session,
                                                    sample_monsters: list[Monster],
                                                    sample_slayer_tasks: list[SlayerTask]):
